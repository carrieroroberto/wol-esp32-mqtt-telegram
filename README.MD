...
2. **Save the `BOT_TOKEN`** provided by BotFather into your `.env` file.  
3. **Obtain your Telegram user ID** to restrict access to authorized users and set it as `ALLOWED_ID` in `.env`.
